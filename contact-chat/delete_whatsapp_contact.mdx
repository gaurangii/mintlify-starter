...
This API endpoint allows you to update the status of users in your  Cube6 application.

**Endpoint URL:** `https://api.v7. Cube6.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Cube6.com/inbox/users/status-update' \
  -X 'PUT' \
