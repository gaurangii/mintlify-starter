...
This API endpoint allows you to update the status of users in your  Voxloud application.

**Endpoint URL:** `https://api.v7. Voxloud.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Voxloud.com/inbox/users/status-update' \
  -X 'PUT' \
