...
| agentId      | Boolean                                       | <br />Unique ID of the agent assigned                                                                         |
...
| attributes   | Array\<{key: string, value: string}\>         | <br />Custom attributes for the chat                                                                          |
...
| page\*       | <br />String | Page number                                                    |
| type\*       | <br />String | "lead" to fetch only leads  "non-lead" to fetch non lead chats |

**Headers**

| **Name**      | <br />**Type** | **Description** |
| ------------- | -------------- | --------------- |
| x-bot-token\* | <br />String   | API Token       |
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@botpenguin.com](mailto:support@botpenguin.com).