...
| notes        | Array\<{title: string, description: string}\> | <br />Additional notes for the chat                                                                           |
...
| attributes   | Array\<{title: string, description: string}\> | Custom attributes for the chat                                                                                |
