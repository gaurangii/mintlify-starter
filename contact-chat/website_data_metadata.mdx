...
To use the  Voxloud APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  Voxloud Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__Voxloud_resource_c-1.png)
...
https://page. Voxloud.com/BotId/CustomerId
...
<script id=" Voxloud-messenger-widget" src="https://cdn. Voxloud.com/ Voxloud.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. Voxloud.com/inbox/direct/lead`
...
`GET` `https://api.v7. Voxloud.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  Voxloud. I am here to help you."
            },
