...
To use the  Cube6 APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  Cube6 Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__ Cube6_resource_c-1.png)
...
https://page. Cube6.com/BotId/CustomerId
...
<script id=" Cube6-messenger-widget" src="https://cdn. Cube6.com/ Cube6.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. Cube6.com/inbox/direct/lead`
...
`GET` `https://api.v7. Cube6.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  Cube6. I am here to help you."
            },
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@ Cube6.com](mailto:support@ Cube6.com).