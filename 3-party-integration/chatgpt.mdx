...
1. Login to your BotPenguin account. Then, select and click the Bot you want to integrate with ChatGPT. Click on the **"Third Party Apps Integration"**
   ...
   ![83 Chatgpt Botpenguin Resource Centre 1 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-1.png)
2. A list of all native integrations for BotPenguin will be available in this window. Find ChatGPT by

- Either by scrolling down the list, or
- By typing ****‘ChatGPT’**** in the Search Box with the placeholder **“Search Here”.**

  ![83 Chatgpt Botpenguin Resource Centre 2 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-2.png)
...
5. Enter all the details shown on the subsequent page to connect ChatGPT to your chatbot.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 3 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-3.png)
...
2. Click on the "API Platform" on the left hand side, followed by the "API login"
   ...
   ![83 Chatgpt Botpenguin Resource Centre 4 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-4.png)

   ![83 Chatgpt Botpenguin Resource Centre 5 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-5.png)
3. You will be directed to the "platform.openai.com/docs/overview" page, where search for "API Keys" in the search bar and select the option.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 6 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-6.png)
4. The page that opens will contain options to create new API keys. Click on the "**Create new secret key**" button in the center.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 7 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-7.png)
5. Enter the required details on the opened form. Choose the service account. The details include:
   ...
   - The Project for which the key will be used.
     ...
     ![83 Chatgpt Botpenguin Resource Centre 8 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-8.png)
...
6. After entering the relevant details and clicking "Create secret key", the secret key will be created. **Save the key in a secure method**, as you won't be able to view it again.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 9 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-9.png)
7. Click on "**Done**", and the following will be displayed:

   ![83 Chatgpt Botpenguin Resource Centre 9 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-10.png)
...
1. To add credits to your ChatGPT token, open the left hand sidebar. You will see a billings tab. Proceed to click on the "Billing" Tab.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 11 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-11.png)
2. Click on "Add Payment details" and input of details.

   ![83 Chatgpt Botpenguin Resource Centre 12 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-12.png)
...
1. Enter the secret key, and press \*\*Authenticate, \*\*to complete the integration of BotPenguin with ChatGPT.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 13 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-13.png)
...
5. Also, your ChatGPT integration will reflect the message **Installed** in the Integration List.
   ...
   ![83 Chatgpt Botpenguin Resource Centre 14 Pn](/images/how-botpenguin-works/chtgpt/83.chatgpt__botpenguin_resource_centre-14.png)
