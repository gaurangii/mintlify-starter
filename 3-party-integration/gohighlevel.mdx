---
title: "Integrate BotPenguin with GoHigh Level"
description: "This is the guide for integrating BotPenguin with GoHighLevel Integration"
---
...
- **Streamlined Lead Management** – Capture and sync BotPenguin leads directly into GoHighLevel’s CRM for centralized tracking.
- **Automated Follow-Ups** – Trigger SMS, email, and voicemail campaigns based on chatbot interactions without manual intervention.
- **Unified Customer Journey** – Combine GoHighLevel funnels and BotPenguin conversations for a seamless engagement flow.
- **Smart Workflow Automation** – Use BotPenguin chat events to initiate GoHighLevel workflows and nurture sequences.

---

## **Steps for Integration:**

#### **Step 1. Navigating to GHL in BotPenguin:**

1. Log into your BotPenguin account, and go to your desired bot. Click on “**Third-party Apps Integrations**” option to go to all available 3rd Party Integrations page.
2. \
...
3. **Step 4: Set Up Mapping Parameters**
   ...
   Now that the connection between BotPenguin and GoHighLevel (GHL) CRM is established, you need to map parameters (fields) of GHL CRM to the user responses from BotPenguin's chatbot.
   1. You can use the **\+Add Parameters** button to add more fields.

      <Info>
        **Example Mapping Process**
        1. **Select a Question from BotPenguin Chat Flow**
...
2. \
   As a result, this mapping will enable the integration to **send the user's response from BotPenguin to GoHighLevel's CRM fields**, storing it correctly in the contact records.
