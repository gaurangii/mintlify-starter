---
title: "Integrate  Cube6 with GoHigh Level"
description: "This is the guide for integrating  Cube6 with GoHighLevel Integration"
---
...
- **Streamlined Lead Management** – Capture and sync  Cube6 leads directly into GoHighLevel’s CRM for centralized tracking.
- **Automated Follow-Ups** – Trigger SMS, email, and voicemail campaigns based on chatbot interactions without manual intervention.
- **Unified Customer Journey** – Combine GoHighLevel funnels and  Cube6 conversations for a seamless engagement flow.
- **Smart Workflow Automation** – Use  Cube6 chat events to initiate GoHighLevel workflows and nurture sequences.

---

## **Steps for Integration:**

#### **Step 1. Navigating to GHL in  Cube6:**

1. Log into your  Cube6 account, and go to your desired bot. Click on “**Third-party Apps Integrations**” option to go to all available 3rd Party Integrations page.
2. \
...
3. **Step 4: Set Up Mapping Parameters**
   ...
   Now that the connection between  Cube6 and GoHighLevel (GHL) CRM is established, you need to map parameters (fields) of GHL CRM to the user responses from  Cube6's chatbot.
   1. You can use the **\+Add Parameters** button to add more fields.

      <Info>
        **Example Mapping Process**
        1. **Select a Question from  Cube6 Chat Flow**
...
2. \
   As a result, this mapping will enable the integration to **send the user's response from  Cube6 to GoHighLevel's CRM fields**, storing it correctly in the contact records.
