---
title: "Integrate  Cube6 with Shipway CRM"
...
integration of  Cube6 with Shipway.
...
a. Now, as connection of the  Cube6 and Shipway is established, you need

to map **parameters (fields) of Shipway** to the user response of the  Cube6 question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 Cube6 to the Shipway’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Shipway fields.
...
Once you have established a connection between ** Cube6** and **Shipway**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  Cube6 dashboard as well as in the Shipway you have integrated.
