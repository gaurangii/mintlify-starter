---
title: "Integrate BotPenguin with Extraaedge CRM"
...
complete integration of BotPenguin with Extraaedge CRM.
...
a. Now, as connection of the BotPenguin and Extraaedge is established, you need

to map **parameters (fields) of Extraaedge** to the user response of the BotPenguin question.
...
BotPenguin to the Extraaedge’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Extraaedge fields.
...
Once you have established a connection between **BotPenguin** and **Extraaedge**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your BotPenguin dashboard as well as in the Extraaedge you have integrated.
