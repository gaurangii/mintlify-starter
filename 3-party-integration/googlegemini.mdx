---
title: "Integrate BotPenguin with Google Gemini"
description: "This page provides an in-depth guide on integrating BotPenguin with Google Gemini.
...
<AccordionGroup>
  <Accordion title="Which Gemini models are supported in BotPenguin?">
  ...
  <Accordion title="Can I use both OpenAI and Gemini models in one BotPenguin account?">
