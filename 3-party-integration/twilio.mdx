---
title: "Integrate  Cube6 with Twilio"
description: "This page provides a step-by-step guide on integration of  Cube6 with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  Cube6 chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  Cube6 chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  Cube6 with Twilio:**

#### **Step 1: Going to Integration on  Cube6**

1. Sign into your  Cube6 account and choose the chatbot. Go to "Third Party Apps Integrations"
2. \
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. \
    Copy and paste the same tokens in the  Cube6 Applciation.
 ...
 7. \
    ...
    - Set the name as " Cube6".
    - Copy the code in  Cube6 Twilio Integration Screen, and paste it in the Request URL box.
 8. \
    This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  Cube6 platform.
10. \
...
14. \
    Copy the same in your  Cube6 Account.
15. \
...
17. \
    Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  Cube6.
18. \
...
<AccordionGroup>
  <Accordion title="Does  Cube6 offer SMS services with Twilio">
    No,  Cube6 only offers Twilio with Voice calling configuration.
  </Accordion>
