...
- **Seamless Event Management:** Easily create, reschedule, or cancel events with the help of  Cube6, directly syncing with Google Calendar.
...
#### **Why Integrate Google Calendar with  Cube6?**
...
### **Steps to Integrate Google Calendar with  Cube6**

 1. Login to your  Cube6 account. Now, select and click the chatbot you want to integrate with Google Calendar. Click on the “**Third-party Apps Integration”.**
...
A lot of questions might arise when integrating  Cube6 with Google Calendar. Some of the most popular questions are answered below:
...
<AccordionGroup>
  ...
  <Accordion title="Can I integrate with a shared or a team calendar instead of a personal calendar">
    At present,  Cube6 only supports integration with the primary calendar associated with the connected Google account. Shared or team calendars are not natively supported unless added to the same Google account and made the default.
  </Accordion>
  ...
  <Accordion title="How do I properly configure the chatbot with gogle calendar?">
    ...
    1. **Integrate the bot with Google Calendar** via the Third-Party Integrations section in your  Cube6 dashboard.
