---
title: "Integrate BotPenguin with Google Sheets"
description: "This page contains the stepwise tutorial for the integration of Google Sheets with BotPenguin"
---
...
1. Now, you need to map **parameters (fields) of Google Sheets** to the user response of the BotPenguin question. In other words, you need to map the questions or custom attributes that will be saved to the Google Sheet. The fields that need to be entered are:
...
<Warning>
  Make sure you have a empty sheet made in your google sheet account, so it can be connect to BotPenguin.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="How can I test whether my integration is working?">
    After setup, run a **dummy test lead** through the chatbot. If configured properly, the data should appear in your **Google Sheet** and also reflect in your **BotPenguin dashboard.**
  </Accordion>
