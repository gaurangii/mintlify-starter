---
title: "Integrate  Cube6 with NetHunt CRM"
...
to complete integration of  Cube6 with NetHunt.
...
a. Now, as connection of the  Cube6 and NetHunt CRM is established, you need

to map **parameters (fields) of NetHunt CRM** to the user response of the  Cube6 question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 Cube6 to the NetHunt CRM’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to NetHunt CRM fields.
...
Once you have established a connection between ** Cube6** and **NetHunt CRM**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  Cube6 dashboard as well as in the NetHunt CRM that you have integrated.
