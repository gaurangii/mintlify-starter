---
title: "Integrate BotPenguin with Salesforce CRM"
...
1. Login to your BotPenguin account. Now, select and click the Bot you want to
...
1. Enter the Salesforce Domain, Client ID and Client Secret and click the ‘Connect’ button to complete integration of BotPenguin with Salesforce.
...
1. Now, as the connection of the BotPenguin and Salesforce CRM is established, you need to map **parameters(fields) of Salesforce CRM** to the user response to the BotPenguin question.
