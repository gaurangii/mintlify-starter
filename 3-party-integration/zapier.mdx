---
title: "Integrate BotPenguin with Zapier"
description: "This page contains the step wise tutorial for the integration of Zoho CRM with BotPenguin."
---

### **What is Zapier.**

Zapier is an automation tool which helps making a connecting between apps. You can set BotPenguin and apps in zapier as triggers and actions.

---

### **Benifits of using Zapier:**

- **Seamless Automation:** Instantly connect BotPenguin with thousands of apps without custom coding.
...
### **Steps to use Botpenguin with Zapier**

 1. Log in to your BotPenguin account and select a bot you wish to integrate with Zapier.
 ...
 4. Then go to Zapier website.
    ...
    [BotPenguin Integrations | Connect Your Apps with ZapierZapier](https://zapier.com/apps/botpenguin/integrations)
 5. Here you can see all the supported Triggers and Actions that are available to be used with Botpenguin.
...
11. Select BotPenguin from the list as trigger.
12. Then select a trigger event from the list of available events.
13. After that click on "Sign In" to connect botpenguin.
14. \
...
16. Then enter the API Key which is available in Developers section inside Access Token in Botpenguin.
17. Then enter the Bot Id, you can click on "edit" in Zapier Integration Page to get Bot Id for the same.
18. And click "Yes Continue with Botpenguin".
...
**Similarly you can use other apps as TRIGGERS and Botpenguin as ACTION**
