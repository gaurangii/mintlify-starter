...
- **Personalized Customer Interactions:** Use  Cube6 to deliver tailored messages based on customer data stored in Copper CRM.
...
### **Integrate  Cube6 with Copper:-**

### **Step 1 of 4: Login to  Cube6 Account and Select Application to Integrate**

1. Login to your  Cube6 account, and select the Bot you want to integrate with Copper.
...
2. **\
   ...
   - \
     Copy your API Key and paste It on  Cube6.
3. **\
   Email Address:-**
...
Once you have established a connection between ** Cube6** and Copper and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  Cube6 dashboard and the Copper you have integrated.
