---
title: "Integrate  Cube6 with Make.com"
description: "This page contains step by step guide on how you can integrate the make.com with  Cube6."
---

You can connect  Cube6 with [Make.com](http://Make.com) to automate the lead details.

<Info>
  The following **TRIGGERS** can be set in  Cube6:

  1. Watch New Contact Created -\> This will be trigger when a new contact is created on  Cube6 platform.
  2. Watch New Incoming Message -\> This will be triggered when a new incoming message is received on  Cube6 platform.
  3. Watch New WhatsApp Order placed -\> This will be triggered when a new order on Whatsapp bot will be placed.
</Info>

<Info>
  The following **ACTIONS** can be used in  Cube6:

  1. Add a contact -\> This will add a contact to your  Cube6 Account
...
### **How to use  Cube6 as Trigger**

 1. Log in to your  Cube6 account.
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  Cube6 in the search bar.
 9. Select the trigger events for your bot to initiate the action. Here we have selected "Watch New Contact Created"

    <Info>
      Procedure for setting up other  Cube6 Triggers are same
    </Info>
10. \
...
- Then enter the API Key from your  Cube6 account. (Follow instructions available below)
- Select the platform of the bot you are integrating with.
- Then paste the BotID which you copied earlier from [Make.com](http://Make.com) third party integration in  Cube6

Then click on "Save" button and your Trigger is set.

**You can get API Key from the "Developers" section in  Cube6. Then click on Access Token and copy the same.**

12. \
    Then you have to add an action which will take place once event trigger takes place.
13. Click on the "\+" icon next to  Cube6 Bubble to add an action. Here we have used Google Sheets as action.
14. \
...
19. Then go to  Cube6 and select the bot which you were integrating with [Make.com](http://Make.com)
...
<Info>
  Remember that the contact info entered should not be available on  Cube6 platform previously. As it will be considered as revisit lead and will not be triggered by  Cube6 app in Google sheet or any other app which is used as an action.
</Info>

### **How to use Action in  Cube6**
 ...
 7. Search for  Cube6 and select an Action event which will take place after receiving the trigger.
 8. \
    Set up connection by providing the **API key and BotID **from  Cube6 as explained above.
...
You have successfully connected  Cube6 as action. Once a trigger takes place your bot will follow the action.
