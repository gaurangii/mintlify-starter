---
title: "Integrate  Cube6 with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Cube6."
---

#### **Integration of Google Analytics with  Cube6**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Cube6 chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Cube6:

**Step 1: Log in to  Cube6**

1. Navigate to your [ Cube6 account](https://www. Cube6.com/).
...
To connect Google Analytics to your  Cube6 account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Cube6**

1. Go back to the  Cube6 integration page where you clicked **Connect** for Google Analytics.
