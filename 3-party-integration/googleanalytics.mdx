---
title: "Integrate  Voxloud with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Voxloud."
---

#### **Integration of Google Analytics with  Voxloud**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Voxloud chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Voxloud:

**Step 1: Log in to  Voxloud**

1. Navigate to your [ Voxloud account](https://www. Voxloud.com/).
...
To connect Google Analytics to your  Voxloud account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Voxloud**

1. Go back to the  Voxloud integration page where you clicked **Connect** for Google Analytics.
