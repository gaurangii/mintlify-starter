...
### **How to Create Your Facebook Chatbot?**
 ...
 2. To start creating your new chatbot, click **"Create New Bot."**
    ...
    ![9 Facebook Chatbot Botpenguin Resource Centre 1 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-1.png)
 3. Select the primary purpose for creating your bot and proceed further.

    ![9 Facebook Chatbot Botpenguin Resource Centre 2 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-2.png)
 4. Select "**Facebook Chatbot**" to begin creating your chatbot.

    ![9 Facebook Chatbot Botpenguin Resource Centre 3 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-3.png)
 5. Now click on login and connect your facebook account.

    ![9 Facebook Chatbot Botpenguin Resource Centre 4 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-4.png)
 ...
 7. If you want to create a new Facebook account, click on “Create New Account”
    ...
    ![9 Facebook Chatbot Botpenguin Resource Centre 5 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-5.png)

    ![9 Facebook Chatbot Botpenguin Resource Centre 6 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-6.png)
 ...
 9. Then click on "continue".
    ...
    ![9 Facebook Chatbot Botpenguin Resource Centre 7 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-7.png)
10. You can check and review BotPenguin's access request and then click on save to move ahead.

    ![9 Facebook Chatbot Botpenguin Resource Centre 8 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-8.png)
...
12. You can now edit the flow for your bot. And you can now do customizations accordingly.
    ...
    ![9 Facebook Chatbot Botpenguin Resource Centre 9 Pn](/images/create-newchatbot/9.facebook_chatbot__botpenguin_resource_centre-9.png)
