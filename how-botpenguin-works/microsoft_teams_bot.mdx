...
2. Once logged in, Navigate to the developer portal of MS Teams.
   ...
   ![11 Microsoft Teams Bot Botpenguin Resource Centre 1 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-1.png)
3. Choose the "Tools" tab and click on "Bot Management Option"

   ![11 Microsoft Teams Bot Botpenguin Resource Centre 2 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-2.png)
...
5. Once the bot is created, Enter the following Webhook endpoint address and click "save" to proceed. https://api.v7.botpenguin.com/ms-teams/webhook
   ...
   ![11 Microsoft Teams Bot Botpenguin Resource Centre 3 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-3.png)
6. Navigate to "Client Secrets" and add new and Copy the Provide secret key. Keep this secret key safe. This will be used while creating the configuration on BotPenguin.
   ...
   ![11 Microsoft Teams Bot Botpenguin Resource Centre 4 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-4.png)
7. Return to the bot listing page and copy the "Bot ID". Keep this key safe. This will be used while creating the configuration on BotPenguin.
   ...
   ![11 Microsoft Teams Bot Botpenguin Resource Centre 5 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-5.png)
...
3. Fill in the basic information of the App.   An example of the same is as follows
   ...
   - App ID: Same as Bot ID
     ...
     ![11 Microsoft Teams Bot Botpenguin Resource Centre 6 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-6.png)
4. You can give your own branding to your app or leave as it is.

   ![11 Microsoft Teams Bot Botpenguin Resource Centre 7 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-7.png)
5. Navigate to the "App Features" tab and add the "Bot". Once the next page opens, choose the relevant bot and assign the following scopes
   ...
   - Upload and Download files
     ...
     ![11 Microsoft Teams Bot Botpenguin Resource Centre 8 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-8.png)
     9. Now, Move to the "Publish to Org" tab, and Submit your app for your organization.

        ![11 Microsoft Teams Bot Botpenguin Resource Centre 9 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-9.png)
   ...
   2. Locate the "Manage Apps" options under the "Team Apps" Section. Search for your app and click on the same.
      ...
      ![11 Microsoft Teams Bot Botpenguin Resource Centre 10 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-10.png)
   ...
   4. Name your bot and Fill in the Bot ID and Bot Secret (Bot Password) which you copied in 1st step.
      ...
      ![11 Microsoft Teams Bot Botpenguin Resource Centre 11 Pn](/images/create-newchatbot/11.microsoft_teams_bot__botpenguin_resource_centre-11.png)
