...
1. Login to your cube6 Portal and Click the "Create Bot" button on the top right.
   ...
   ![7 Whatsapp Chatbot cube6 Resource Centre 1 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-11.png)
2. Select "WhatsApp" as the platform on the next page.

   Choose Platform

   ![7 Whatsapp Chatbot cube6 Resource Centre 12 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-12.png)
3. Provide the required details and follow the bot creation process.

   ![7 Whatsapp Chatbot cube6 Resource Centre 5 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-5.png)
4. Scan the QR Code and initiate a WhatsApp message to create the demo bot 1st. Scan or Send Confirmation message

   ![7 Whatsapp Chatbot cube6 Resource Centre 6 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-6.png)
5. Upon successful verification, Click "Connect to your WhatsApp number" to start the Automated onboarding.

   ![7 Whatsapp Chatbot cube6 Resource Centre 7 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-7.png)

#### **2.2 Complete Meta Automated onboarding**

1. Select all the pre-requisite and click "Proceed"

   ![7 Whatsapp Chatbot cube6 Resource Centre 8 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-8.png)
2. Choose Automated or Manual onboarding. In this document, We will talking about Automated onboard.

   ![7 Whatsapp Chatbot cube6 Resource Centre 9 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-9.png)
3. It will open up a new pop-up window where you have to complete the Meta onboarding.

   ![7 Whatsapp Chatbot cube6 Resource Centre 10 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-10.png)
...
![7 Whatsapp Chatbot cube6 Resource Centre 1 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-1.png)
...
![7 Whatsapp Chatbot cube6 Resource Centre 2 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-2.png)
...
![7 Whatsapp Chatbot cube6 Resource Centre 3 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-3.png)
...
![7 Whatsapp Chatbot cube6 Resource Centre 4 Pn](/images/create-newchatbot/7.whatsapp_chatbot__cube6_resource_centre-4.png)
