...
1. Go to the "API Setup" section under "WhatsApp" in the dashboard sidebar.
   ...
   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 1 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-1.png)
2. Proceed to "Step 3: Configure webhooks to receive messages" in the API setup page.
3. Click on the "Configure webhooks" button.

   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 2 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-2.png)

#### **Step 3: Edit Webhook Callback URL**

1. Under the "Configuration" page, click on the "Edit" button.

   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 4 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-3.png)
...
4. After entering the details, click on the "Verify and save" button.
   ...
   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 4 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-4.png)
...
1. Once the webhook URL is saved, click on the "Manage" button to subscribe to the webhook fields.
   ...
   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 5 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-5.png)
2. When the "Webhook fields" pop-up appears, subscribe to all available fields.
3. Save your selections.

   ![224 Subscribe Wa Webhook With Botpenguin Botpenguin R 6 Pn](/images/platform-guidelines-training/subscribe-wa-webhook/224.subscribe_wa_webhook_with_botpenguin__botpenguin_r-6.png)
