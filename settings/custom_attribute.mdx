...
1. Go to  Cube6 and sign in to your account. After logging in, you’ll see the main  Cube6 dashboard with navigation menus.
   ...
   ![191 Custom Attribute  Cube6 Resource Centre 1 Pn](/images/how- Cube6-works/custom-attribute/191.custom_attribute__ Cube6_resource_centre-1.png)
2. In the dashboard side menu, click the **More** button (often marked with three dots or a gear icon). Then select **Account/Settings** from the dropdown. This will open your account settings page.
   ...
   ![191 Custom Attribute  Cube6 Resource Centre 2 Pn](/images/how- Cube6-works/custom-attribute/191.custom_attribute__ Cube6_resource_centre-2.png)
3. In the Account/Settings area, find and click the **Custom Attributes** tab. This takes you to the Custom Attributes page, where all your attributes are listed. (If this is your first time, the list may be empty.) On this page you can manage existing attributes or add new ones.
   ...
   ![191 Custom Attribute  Cube6 Resource Centre 3 Pn](/images/how- Cube6-works/custom-attribute/191.custom_attribute__ Cube6_resource_centre-3.png)
