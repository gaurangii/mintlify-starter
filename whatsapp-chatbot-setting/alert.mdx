...
4. **\
   Lead Revisit Notifications Toggle**:
...
5. **\
   When to send Lead info **Here you can customize that when should the email notification should be triggerd wether: a. Begining of the flow b. 5 minutes later. c. End of the flow
6. **Save Changes**:
