...
1. Sign into you cube6 account and select the WhatsApp chatbot.
   ...
   ![61 Triggers cube6 Resource Centre 1 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-1.png)
2. Click on "WhatsApp Bot Setting", and go over to the "Triggers" tab.

   ![61 Triggers cube6 Resource Centre 2 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-2.png)
...
- **Subscribe/Unsubscribe Triggers**: Configure terms (e.g., “start”, “stop”) to automate user opt-ins and opt-outs from marketing flows or broadcasts.
  ...
  ![61 Triggers cube6 Resource Centre 3 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-3.png)
...
- **Contains Match**: The chatflow is triggered if the keyword appears anywhere in the user’s message (e.g., “Can you share pricing details?” triggers the “pricing” flow).
  ...
  ![61 Triggers cube6 Resource Centre 4 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-4.png)
...
- Select the chatflow to be started when the above Ice Breaker is chosen.
  ...
  ![61 Triggers cube6 Resource Centre 5 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-5.png)
...
- **Select the Trigger Action:** Choose what action the command should perform—restart chat, start live chat, subscribe/unsubscribe, or run a chatflow.
  ...
  ![61 Triggers cube6 Resource Centre 6 Pn](/images/how-cube6-works/whatsapp-triggers/61.triggers__cube6_resource_centre-6.png)
