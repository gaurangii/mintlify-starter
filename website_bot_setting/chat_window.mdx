...
4. You can toggle ON/OFF "Enable Transfer to WhatsApp" button. Once switched ON, user can select to transfer chat to whatsapp.
   ...
   ![56 Transfer Chat To Whatsapp Functionality  Cube6 1 Pn](/images/how-botpenguin-works/website-chat-window/56.transfer_chat_to_whatsapp_functionality__Cube6-2.png)
5. Now while chatting with a Website bot, user can click on three dots and select "Transfer to Whatsapp". As shown below

   ![56 Transfer Chat To Whatsapp Functionality  Cube6 1 Pn](/images/how-botpenguin-works/website-chat-window/56.transfer_chat_to_whatsapp_functionality__Cube6-1.png)
6. In the Inbox, a message will be shown indicating that chat has been transferred to whatsapp by the user.

   ![56 Transfer Chat To Whatsapp Functionality  Cube6 3 Pn](/images/how-botpenguin-works/website-chat-window/56.transfer_chat_to_whatsapp_functionality__Cube6-3.png)
