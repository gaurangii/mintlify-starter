...
4. \
   Then you will be redirected to Manage Drip Campaign. Here you can create multiple drip campaigns with scheduled, automated messages to trigger responses from specific user groups.
