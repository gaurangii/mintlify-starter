...
1. Log into your  Cube6 and go to the Instagram Bot.

   ![46 Instagram Broadcast  Cube6 Resource Centre 1 Pn](/images/how- Cube6-works/instagram-broadcast/46.instagram_broadcast__ Cube6_resource_centre-1.png)
2. Go to "**Instagram Automation**".

   ![46 Instagram Broadcast  Cube6 Resource Centre 2 Pn](/images/how- Cube6-works/instagram-broadcast/46.instagram_broadcast__ Cube6_resource_centre-2.png)
3. You will automatically be on the Broadcast page. Give the broadcast a name and then click "**Continue**".

   ![46 Instagram Broadcast  Cube6 Resource Centre 3 Pn](/images/how- Cube6-works/instagram-broadcast/46.instagram_broadcast__ Cube6_resource_centre-3.png)
4. Fill all the details in the a shown on the form:
   ...
   - When to Send: Can send now, or select date and time slot to send broadcast.
     ...
     ![46 Instagram Broadcast  Cube6 Resource Centre 4 Pn](/images/how- Cube6-works/instagram-broadcast/46.instagram_broadcast__ Cube6_resource_centre-4.png)
5. Click on the "**Create Broadcast**" to create the Broadcast.

   ![46 Instagram Broadcast  Cube6 Resource Centre 5 Pn](/images/how- Cube6-works/instagram-broadcast/46.instagram_broadcast__ Cube6_resource_centre-5.png)
...
<AccordionGroup>
  ...
  <Accordion title="Can I schedule a bradcast to a later time?">
    Yes. Under **"When to Send"**, you can select a specific **date and time**. Make sure your time zone settings in  Cube6 are correctly configured to avoid mismatches.
  </Accordion>
