...
<AccordionGroup>
  <Accordion title="How do we collect country, city, mobile number and other metadata">
    1. Voxloud fetches the country and city of a visitor from their IP Address.
  ...
  <Accordion title="How can you call customers with call feature in lead section">
    Voxloud offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with  Voxloud to set up the calling feature in  Voxloud.
  </Accordion>
  <Accordion title="How to integrate Twillo">
    ...
    4. After you fill out these parameters, you can quickly call leads from  Voxloud.
    5. Refer To The Following Steps To Obtain Your API Key and SID On Twilio
  ...
  <Accordion title="What are quick replies and how does it work">
    ...
    You can add quick replies in the  Voxloudon app by following steps:
  ...
  <Accordion title="How to transfer chat to WhatsApp">
    1. Voxloud offers you the option to transfer the chat to WhatsApp or an agent on your support team.
