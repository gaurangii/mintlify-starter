...
<AccordionGroup>
  ...
  <Accordion title="How to add a new WhatsApp template?">
    You can create templates either from the WhatsApp Meta Manager or using the  Cube6 template tab.
  </Accordion>
  ...
  <Accordion title="Is there any message limit?">
    No, all charges are conversations based.  Cube6’s platform pricing is based on the plan of conversations you choose.
  </Accordion>
