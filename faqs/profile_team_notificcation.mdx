...
<AccordionGroup>
  <Accordion title="How to change my email ID">
    You cannot change your email address once you have created your account from the BotPenguin app. However, You can contact BotPenguin at [support@botpenguin.com](mailto:support@botpenguin.com)[.](mailto:support@botpenguin.com) to change your email address.
  </Accordion>
  <Accordion title="How to delete my BotPenguin account">
    Once you login to your BotPenguin account

    1. Navigate to "My Account" section and then click on 'Password" settings.
    2. Here ye can see a button named "Delete Account". Click on that to delete your Botpenguin Account
  </Accordion>
  ...
  <Accordion title="How can a new team member log into the BotPenguin">
    ...
    4. For example, A New Team member here will log in on [app.botpenguin.com](http://app.botpenguin.com) from their email address [xyz@gmail.com](mailto:xyz@gmail.com) and the password above.
  </Accordion>
</AccordionGroup>