...
<AccordionGroup>
  <Accordion title="How to install website bot using javascript">
    Copy the Javascript code from the BotPenguin app & Go to
    ...
    **Please Note**
    ...
    2. Make sure BotPenguin should be the last script to execute, as some scripts may override the BotPenguin script.
  </Accordion>
  <Accordion title="How to install a bot on wordpress website">
    ...
    3. Go to Plugins \> Add new \> Search Botpenguin \> Install now \> Activate plugin"
    4. Install the "BotPenguin" Plugin and then activate the same.
    5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
    6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named "BotPenguin Snippet" that you Copied from your BotPenguin account.
    7. Save the Settings, and you are all set. BotPenguin has been integrated into your website.
  </Accordion>
  <Accordion title="Bot is not showing up upon activation of wp-rocket plugin">
    ...
    3. Add the `BotPenguin` bot script here under `Exclude Java Script Files` option, and done\!
  ...
  <Accordion title="What is the minimum browser version requirement for the BotPenguin website bot">
  ...
  <Accordion title="How to resolve latency issues on my website when I have the chatbot installed">
    ...
    <img
      src="/images/how-botpenguin-works/bot-installation-faq/204.bot_installation_faqs__botpenguin_resource_centre-1.png"
      alt="204 Bot Installation Faqs Botpenguin Resource Centre 1 Pn"
      title="204 Bot Installation Faqs Botpenguin Resource Centre 1 Pn"
      style={{ width:"77%" }}
    />
