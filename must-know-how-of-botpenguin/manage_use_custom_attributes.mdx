...
- From the dropdown menu, select "Account/Settings."
  ...
  ![234 Manage Use Custom Attributes  Cube6 Resource 1 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__Cube6_resource-1.png)
...
- Here, you'll find a list of all your custom attributes. You can edit, delete, bulk delete, and add new custom attributes from this tab.
  ...
  ![234 Manage Use Custom Attributes  Cube6 Resource 2 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__Cube6_resource-2.png)

### **Step 4: Create a New Custom Attribute.**

- To add a new attribute, click the "Add Attribute" button.

  ![234 Manage Use Custom Attributes  Cube6 Resource 3 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__Cube6_resource-3.png)
