---
title: "📨 Send WhatsApp notifications using the BotPenguin APIs"
description: "This page contains the Information on how can you send WhatsApp Notifications from your platform using the BotPenguin APIs"
---
