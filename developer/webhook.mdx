---
title: "Webhooks"
description: "This is a description of the webhooks section under the "Developer" tab in BotPenguin."
---
...
2. Click on the third tab to access the "Webhooks" section.
   ...
   ![189 Webhooks Botpenguin Resource Centre 1 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-1.png)
...
5. Click on "Subscribe Webhooks".
   ...
   ![189 Webhooks Botpenguin Resource Centre 2 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-2.png)
6. A small popup window will open up. Enter your Webhook Endpoint, and verification key. Then, select the bots that you want the webhooks to be triggered for.
   ...
   ![189 Webhooks Botpenguin Resource Centre 3 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-3.png)
...
![189 Webhooks Botpenguin Resource Centre 4 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-4.png)
...
![189 Webhooks Botpenguin Resource Centre 6 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-5.png)
...
3. To disconnect the webhook, turn off the status of the webhook. To disconnect all the webhooks status, click on the "Unsubscribe Webhooks" button and confirm the unhook process.
   ...
   ![189 Webhooks Botpenguin Resource Centre 6 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-6.png)

### **Account Level Webhooks**

![189 Webhooks Botpenguin Resource Centre 7 Pn](/images/how-botpenguin-works/webhook/189.webhooks__botpenguin_resource_centre-7.png)
...
<AccordionGroup>
  <Accordion title="What are webhooks in BotPenguin?">
  ...
  <Accordion title="Which platform do BotPenguin webhooks support?">
